...
namespace WscPrinter_Setup.ApiModels
{
    ...
    public class UserProfile4Wsc
    {
        ...
        public UserProfile4Wsc(UserProfile theWalkingObj)
        {
            ...
            this.ReferenceWebsite = theWalkingObj.ReferenceWebsite != null && theWalkingObj.ReferenceWebsite.Count() > 0 ? quickArrayToString(theWalkingObj.ReferenceWebsite) : "";
            this.OtherReferenceWebsite = theWalkingObj.OtherReferenceWebsite ?? "";
            this.CompanyType = theWalkingObj.CompanyType != null && theWalkingObj.CompanyType.Count() > 0 ? quickArrayToString(theWalkingObj.CompanyType) : "";
